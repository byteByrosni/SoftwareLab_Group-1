    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: on
            ? [
                BoxShadow(
                  color: C.green600.withValues(alpha: .25),
                  blurRadius: 10,
      ...
      child: Text(
        ...
        style: TextStyle(
          fontWeight: FontWeight.w700,
          fontSize: 13.5,
          color: on ? Colors.white : C.ink700,
        ),
      ),
    ),
  );
              ...
              child: AnimatedContainer(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.w700,
                    fontSize: 13,
                    color: current == values[i] ? C.green700 : C.ink500,
                  ),
                ),
              ),
            ),
